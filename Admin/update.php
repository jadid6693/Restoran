	...
	if(isset($_SESSION['AdminLogin']) && $_SESSION['AdminLogin'] !=""){
		if(isset($_POST['upd_btn'])){
			if($_POST['nmaAdmin_txt'] != "" && $_POST['passAdmin_pass'] != "" && $_POST['NoTelp_txt'] != "" && $_POST['Alamat_txt'] != "" && $_POST['ttl_date'] != ""){
				...
				$sql="update admin set NamaAdmin='$namadmin',PasswordAdmin='$passadmin',JenisKelamin='$Jk',NoTelp='$telpadmin',Alamat='$almadmin',TanggalLahir='$ttladmin' where AdminLogin='$AdmLgn'";
